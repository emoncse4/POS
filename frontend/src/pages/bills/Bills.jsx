...
const Bills = () => {
  ...
  return (
    <Layout>
      ...
      {
        popModal && 
        <Modal title="Invoice Details" width={400} pagination={false} open={popModal} onCancel={() => setPopModal(false)}
        footer={false}>
        <div className="card" ref={componentRef}>
            <div className="cardHeader">
                <h2 className="logo">POS</h2>
                <span>Number: <b>+8801402020966</b></span>
                <span>Address: <b>Dhaka, Bangladesh</b></span>
            </div>
